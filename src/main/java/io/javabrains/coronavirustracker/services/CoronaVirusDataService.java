...
public class CoronaVirusDataService {
    ...
    public void fetchVirusData() throws IOException, InterruptedException {
        ...
        for (CSVRecord record : records) {
            ...
            //int totalDeaths = Integer.parseInt(record.get(record.size()));
            //int prevDayDeaths = Integer.parseInt(record.get(record.size()));
            locationStat.setLatestTotalCases(latestCases);
            //locationStat.setTotalDeaths(totalDeaths);
            locationStat.setDiffFromPrevDay(latestCases - prevDayCases);
            //locationStat.setDiffFromPrevDay(totalDeaths - prevDayDeaths);
